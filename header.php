  ...
  <header>
    <div id="top_menu">
      <div id="top_menu_content" class="container">
        <div id="languages">
          <a href="#" class="nav"><img src="Images/drapeau_fr.jpg" alt="Français"></a>
          <a href="#" class="nav"><img src="Images/drapeau-royaume-uni-1.jpg" alt="English"></a>
          <a href="#" class="nav"><img src="Images/drapeau_bzh.jpg" alt="Brezhoneg"></a>
        </div>
        <div id="account">
          <a href="#" class="nav">Espace personnel</a>
        </div>
      </div>
    </div>
    <div id="banner">
    ...
    <nav id="navigation">
      <div id="menuToggle">
        ...
        <ul id="navigation_list_small" class="container">
          ...
          <li><a href="news.php" class="nav">Actualités</a></li>
          <li><a href="#" class="nav">Agenda</a></li>
          <li><a href="#" class="nav">Vie de la commune</a></li>
          <li><a href="#" class="nav">Petites annonces</a></li>
          <li><a href="#" class="nav">Découvrir Saint-Rivoal</a></li>
